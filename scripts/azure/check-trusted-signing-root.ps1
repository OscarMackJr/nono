...
#
# Usage: pwsh -File scripts/azure/check-trusted-signing-root.ps1 [-Thumbprint <sha1-hex>]
...
# Exit 2 = harness-internal error (could not fetch/parse the CTL at all —
#          distinct from a confirmed-absent result; never conflate the two)

param(
    [string]$Thumbprint = '991D364E97882715B80ED978F53E1F35DC2F07C2'  # Microsoft Enterprise ID Root CA 2021
)
