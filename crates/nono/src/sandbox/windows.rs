...
/// so that `apply_low_il_label_to_token` (used to label the AppContainer child
/// post-spawn, Plan 62-12) can reuse the identical label path. Both call sites
/// apply this last, making the Low-IL label byte-equivalent across paths.
///
/// # Errors
///
