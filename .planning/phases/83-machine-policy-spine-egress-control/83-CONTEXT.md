...
- **D-13:** The allowlist itself is authored as wildcard FQDNs in `REG_MULTI_SZ` (e.g. `*.anthropic.com`) per EGRESS-01; the policy's presence is what switches deny-by-default enforcement on.
