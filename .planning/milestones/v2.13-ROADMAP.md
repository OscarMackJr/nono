...
- âœ… **v1.0 Windows Alpha** â€” Phases 01-12 (shipped 2026-03-31) â€” see [`milestones/v1.0-*`](milestones/)
- âœ… **v2.0 Windows Gap Closure** â€” Phases 13-18 â€” see [`milestones/v2.0-ROADMAP.md`](milestones/v2.0-ROADMAP.md)
- âœ… **v2.1 Resource Limits / Extended IPC / Attach-Streaming** â€” see [`milestones/v2.1-ROADMAP.md`](milestones/v2.1-ROADMAP.md)
- âœ… **v2.2 Windows/macOS Parity Sweep** â€” see [`milestones/v2.2-ROADMAP.md`](milestones/v2.2-ROADMAP.md)
- âœ… **v2.3 Linux POC Unblock + Deferreds Closure** â€” see [`milestones/v2.3-ROADMAP.md`](milestones/v2.3-ROADMAP.md)
- âœ… **v2.4 Complete the Partial Ports + UPST4** â€” Phases 35, 36, 36.5, 39, 40 (shipped 2026-05-15) â€” see [`milestones/v2.4-ROADMAP.md`](milestones/v2.4-ROADMAP.md)
- âœ… **v2.5 Backlog Drain + UPST5** â€” Phases 37, 41, 42, 43 (shipped 2026-05-20) â€” see [`milestones/v2.5-ROADMAP.md`](milestones/v2.5-ROADMAP.md)
- âœ… **v2.6 UPST6 + v2.5 Drain** â€” Phases 44, 44.1, 45, 46, 47, 48, 49, 50 (shipped 2026-05-25) â€” see [`milestones/v2.6-ROADMAP.md`](milestones/v2.6-ROADMAP.md)
- âœ… **v2.7 Windows supervised-run hardening** â€” Phases 51, 52 (shipped 2026-05-26) â€” see [`milestones/v2.7-ROADMAP.md`](milestones/v2.7-ROADMAP.md)
- âœ… **v2.8 UPST7 + v2.7 Drain & Release** â€” Phases 53-59 (shipped 2026-06-06; tags `v2.8`+`v0.57.5`) â€” see [`milestones/v2.8-ROADMAP.md`](milestones/v2.8-ROADMAP.md)
- âœ… **v2.9 Windows Sandbox-the-Tools â€” Confined Coding Loop** â€” Phases 60, 61, 62 (published as `v0.62.2` 2026-06-06) â€” see [`milestones/v2.9-ROADMAP.md`](milestones/v2.9-ROADMAP.md)
- âœ… **v2.10 Kernel-Driver Spike + EDR UAT + macOS Upstream Parity** â€” Phases 63-66 (shipped 2026-06-11; tag `v2.10`) â€” see [`milestones/v2.10-ROADMAP.md`](milestones/v2.10-ROADMAP.md)
- âœ… **v2.11 Clean-Host Distribution Cleanup + UPST8** â€” Phases 67-70 (shipped 2026-06-13) â€” see [`milestones/v2.11-ROADMAP.md`](milestones/v2.11-ROADMAP.md)
- âœ… **v2.12 AI Agent Abstraction** â€” Phases 71-75 (shipped 2026-06-16; tag `v2.12`) â€” see [`milestones/v2.12-ROADMAP.md`](milestones/v2.12-ROADMAP.md)
- ðŸ”µ **v2.13 Carry-Forward Closeout (Dark Factory)** â€” Phases 76-81 (active) â€” below

## Phases

### v2.13 Carry-Forward Closeout (Dark Factory) â€” Active
...
- [x] Phase 71: Engine-Agnostic Launch Productionization (5/5, ENG-01/02/03) â€” 2026-06-14
- [x] Phase 72: nono-py Binding + In-Process-Exec Proof (4/4, ABI-01/02) â€” 2026-06-14
- [x] Phase 73: AI_AGENT Marker (3/3, MARK-01) â€” verified 2026-06-16
- [x] Phase 74: Persistent Multi-Tenant Daemon (8/8, DMON-01/02/03) â€” 2026-06-15 *(marquee)*
- [x] Phase 75: Supplementary Controls + Secondary Engines (8/8, SUPP-01/02/03) â€” 2026-06-16
...
<details>
<summary>âœ… v2.11 Clean-Host Distribution Cleanup + UPST8 (Phases 67-70) â€” SHIPPED 2026-06-13</summary>

- [ ] Phase 67: Clean-Host Windows Install (DIST-01/02, TRUST-01/02) â€” host-gated UAT carried to v2.13 Phase 80
- [x] Phase 68: macOS Resource-Limit Enforcement Fix (2/2) â€” completed 2026-06-12
- [x] Phase 69: UPST8 Audit (1/1) â€” completed 2026-06-13
- [x] Phase 70: UPST8 Cherry-pick Sync (3/3) â€” completed 2026-06-13
...
<details>
<summary>âœ… v2.10 Kernel-Driver Spike + EDR UAT + macOS Upstream Parity (Phases 63-66) â€” SHIPPED 2026-06-11</summary>

- [x] Phase 63: Minifilter Spike Groundwork + macOS DIVERGENCE-LEDGER Audit (3/3) â€” completed 2026-06-08
- [x] Phase 64: Minifilter Spike Implementation + macOS P1 Cherry-pick Wave (5/5) â€” completed 2026-06-09
- [x] Phase 65: Minifilter ADR + macOS Live Re-validation (4/4) â€” completed 2026-06-11
- [x] Phase 66: WR-02 EDR HUMAN-UAT (1/1) â€” completed 2026-06-11
...
<details>
<summary>âœ… v2.8 / v2.9 (Phases 53-62) â€” SHIPPED 2026-06-06</summary>
...
**Goal**: Deliver the shared scripted-gate framework â€” single-invocation unattended scripts that emit machine-readable pass/fail verdicts â€” so every subsequent host-gated phase can drop interactive human UAT in favor of a scripted run.
...
**Plans**: 2 plans
- [x] 76-01-PLAN.md â€” Runner `scripts/verify-dark.ps1` (gate auto-discovery, precondition dispatch, D-01 verdict emit, D-02 exit mapping, `.nono-runtime/verdicts/` persistence) + `.nono-runtime/` gitignore rule
- [x] 76-02-PLAN.md â€” `scripts/gates/harness-self-check.ps1` (Test-Precondition/Invoke-Gate contract reference) + end-to-end proof of the 5 ROADMAP success criteria
**Host gate**: Real Win11 host (the harness must execute without operator prompts to be validated).
**Unattended gate**: `scripts/verify-dark.ps1 --gate harness-self-check` â€” exits 0 with JSON `PASS` verdict; this IS the gate for Phase 76.

### Phase 77: Copilot CLI End-to-End Confinement
**Goal**: GitHub Copilot CLI completes a real task end-to-end under AppContainer confinement â€” replacing the v2.12 confine-only re-scope â€” by fixing the Node-ESM `realpathSync`/`lstat` ancestor `FILE_READ_ATTRIBUTES` denial and providing a verified idempotent one-time-admin setup step for the system-ancestor ACL grants (`C:\`, `C:\Users`).
...
**Success Criteria** (what must be TRUE):
  ...
  3. An idempotent generic `nono setup --grant-ancestors --profile <p>` step (D-06) grants the well-known `ALL APPLICATION PACKAGES` SID `S-1-15-2-1` RA (D-05 resolution) on the system ancestors (drive root and Users dir) â€” one-time-admin, documented as non-destructive (does not alter DACL deny entries or remove existing ACEs) â€” and is safe to run repeatedly.
...
**Plans**: 3 plans
- [x] 77-01-PLAN.md â€” CPLT-01: runtime ancestor-RA grant (grant_sid_read_attributes_on_path + AppliedAncestorReadAttributesGuard) wired onto the AppContainer launch arm + node.exe interpreter coverage in the copilot-cli profile
- [x] 77-02-PLAN.md â€” CPLT-02: generic idempotent one-time-admin nono setup --grant-ancestors --profile <p> granting the well-known ALL APPLICATION PACKAGES SID RA on the system ancestors
- [x] 77-03-PLAN.md â€” CPLT-03: scripts/gates/copilot-e2e.ps1 unattended dark-factory gate + permanent-grant docs + host-gated end-to-end proof
- [x] 77-04-PLAN.md â€” CPLT-01 gap closure: extend ancestor-RA guard to the --workspace chain (multi-target, dedup) â€” closes the realpathSync lstat 'C:\Users\<user>' EPERM found in the 77-03 host proof
**Host gate**: Real Win11 host + GitHub Copilot CLI installed + one-time-admin step runnable.
**Unattended gate**: `scripts/verify-dark.ps1 --gate copilot-e2e` â€” replaces the interactive SC3 UAT from v2.12 Phase 75.
...
**Depends on**: Phase 74 daemon (already shipped â€” `nono-agentd` serves `\\.\pipe\nono-agentd-control`)
...
**Success Criteria** (what must be TRUE):
  ...
  3. The `Classify` verb enforces the same Low-IL-denying SDDL posture as the existing `nono-agentd-control` pipe â€” a caller running at Low IL is denied with a clear error rather than receiving a spoofable answer.
...
**Plans**: 2 plans
Plans:
- [x] 78-01-PLAN.md â€” Daemon-side Classify verb: ControlRequest::Classify variant + handle_classify + unit tests (unattended gate)
- [x] 78-02-PLAN.md â€” Client routing: daemon-first classify + structural fallback + integration test + human-verify checkpoint
**Host gate**: Real Win11 host with `nono-agentd` running (daemon from Phase 74 â€” already proven on Win11 26200).
...
**Depends on**: Phase 76 (WFP isolation gate uses harness framework); Phase 74 daemon (per-agent WFP is daemon-keyed â€” already shipped in Phase 75)
**Requirements**: WFP-01, TSRG-01
**Success Criteria** (what must be TRUE):
  1. An automated gate (`scripts/verify-dark.ps1 --gate wfp-egress-isolation`) launches two confined agents with distinct AppContainer package SIDs under a network-scoped profile â€” agent A's allowed egress to a local mock server succeeds while agent B (no `allow_domain`) is denied â€” both verdicts machine-verifiable in one unattended run.
...
Plans:
**Wave 1**
- [x] 79-01-PLAN.md â€” WFP-01: three policy.json profiles + wfp-egress-isolation gate (loopback mock, SKIP_HOST_UNAVAILABLE guard, per-SID isolation proof)

**Wave 2** *(blocked on Wave 1 completion)*
- [x] 79-02-PLAN.md â€” TSRG-01: D-03/D-04 wiring in windows_confined_run.rs (default profile injection + exe-dir auto-cover) + napi integration test + npm test wiring
...
**Success Criteria** (what must be TRUE):
  ...
  2. `nono-wfp-service` starts successfully or, if it fails transiently, the failure is non-fatal and does not roll back the MSI install â€” the machine is in a usable state regardless.
...
Plans:
**Wave 1**
- [x] 80-01-PLAN.md â€” Build fix: .cargo/config.toml (+crt-static, D-03) + build-windows-msi.ps1 vital=no/ErrorControl=ignore (D-04) + validate-windows-msi-contract.ps1 contract assertions

**Wave 2** *(blocked on Wave 1 completion)*
- [x] 80-02-PLAN.md â€” Unattended gate: scripts/gates/clean-host-install.ps1 (Test-Precondition dirty-host detection + Invoke-Gate msiexec orchestration, D-01..D-07)
**Host gate**: Clean Win11 host (no prior nono, no VC++ runtime, no pre-trusted cert â€” this is the definition of the gate).
**Unattended gate**: `scripts/verify-dark.ps1 --gate clean-host-install` on the clean host â€” single unattended invocation replaces the Phase 67 interactive UAT.

### Phase 81: Milestone Close Aggregator
**Goal**: Collect all per-phase verdict artifacts into a single milestone-close aggregator so v2.13 completion is evaluable from harness output alone â€” no human interpretation step required.
...
**Success Criteria** (what must be TRUE):
  ...
  3. The aggregator's output is consumable by a CI pipeline: exit 0 for `PASS`/`PASS_WITH_SKIPS`, non-zero for `FAIL` â€” no post-processing or human judgment required.
...
- `.planning/PROJECT.md` â€” project context + current milestone scope.
- `.planning/MILESTONES.md` â€” shipped milestone history (v1.0 â†’ v2.12).
- `.planning/milestones/v2.12-ROADMAP.md` â€” archived v2.12 roadmap (Phases 71-75); Phase 75 Â§ SC3 + 75-08 is the Copilot carry-forward origin.
- `.planning/templates/cross-target-verify-checklist.md` â€” mandatory Linux+macOS clippy protocol for cfg-gated Unix code.
- `proj/DESIGN-engine-abstraction.md` â€” E1-E5 engine-abstraction contract (Phase 72).
