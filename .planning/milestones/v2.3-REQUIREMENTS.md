...
**Status:** ✅ SHIPPED 2026-05-12 with documented carry-forwards. 15/20 requirements substantively complete (12 direct + 3 transitive via 27.1+27.2). 5 host-blocked requirements (REQ-RESL-NIX-01..03 + REQ-PKGS-01 + REQ-PKGS-04) explicitly carried forward to v2.4 — captured in `.planning/MILESTONE-CONTEXT.md` Theme 2.

Snapshot preserved below as the authoritative v2.3 acceptance record. For v2.4+ work, see the live `.planning/REQUIREMENTS.md` (created at v2.4 milestone start).
