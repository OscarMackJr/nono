...
- [x] 76-02-PLAN.md — `scripts/gates/harness-self-check.ps1` (Test-Precondition/Invoke-Gate contract reference) + end-to-end proof of the 5 ROADMAP success criteria
